...
const envConfig = {
  ...
  partialTakeProfitPct: process.env.PARTIAL_TAKE_PROFIT_PCT ? parseFloat(process.env.PARTIAL_TAKE_PROFIT_PCT) : undefined,
  partialTakeProfitSharePct: process.env.PARTIAL_TAKE_PROFIT_SHARE_PCT ? parseFloat(process.env.PARTIAL_TAKE_PROFIT_SHARE_PCT) : undefined,
  breakevenActivatePct: process.env.BREAKEVEN_ACTIVATE_PCT ? parseFloat(process.env.BREAKEVEN_ACTIVATE_PCT) : undefined,
  breakevenFloorPct: process.env.BREAKEVEN_FLOOR_PCT ? parseFloat(process.env.BREAKEVEN_FLOOR_PCT) : undefined,
  recoveryEnabled: process.env.RECOVERY_ENABLED !== undefined ? process.env.RECOVERY_ENABLED === 'true' : undefined,
